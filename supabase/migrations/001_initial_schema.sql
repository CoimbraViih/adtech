...
create index if not exists ws_members_user_id_idx on workspace_members(user_id);
create index if not exists ws_members_ws_id_idx   on workspace_members(workspace_id);
