...
export function UserMenu() {
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent
        align="end"
        className="w-60 bg-[color:var(--adflow-surface)] border-[color:var(--adflow-border)]"
      >
        ...
        <DropdownMenuItem className="gap-2 text-[color:var(--adflow-fg)] hover:bg-[color:var(--adflow-border)] cursor-pointer focus:bg-[color:var(--adflow-border)]">
        ...
        <DropdownMenuItem className="gap-2 text-[color:var(--adflow-danger)] hover:bg-[color:var(--adflow-border)] cursor-pointer focus:bg-[color:var(--adflow-border)]">
